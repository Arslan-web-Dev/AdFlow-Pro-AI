...
export default function Home() {
  return (
    <div className="min-h-screen bg-[var(--background)] overflow-hidden">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-[var(--border)] rounded-none">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[var(--primary-gradient)] flex items-center justify-center shadow-lg shadow-[var(--primary-color)]/30">
      ...
      <section className="pt-40 pb-20 px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-[var(--primary-color)]/30 mb-8">
      ...
      <section className="py-24 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {packages.map((pkg) => (
              <div key={pkg.name} className={`h-full ${pkg.popular ? 'ring-2 ring-[var(--primary-color)]' : ''}`}>
