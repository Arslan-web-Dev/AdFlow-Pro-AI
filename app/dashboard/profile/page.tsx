          ...
          <CardContent className="flex flex-col gap-6 p-6 sm:flex-row sm:items-center relative">
            ...
            <div className="relative min-w-0 flex-1 space-y-1">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                ...
                <Badge
                  variant="secondary"
                  className="gap-1 border border-white/10 bg-white/5 font-bold"
                >
          ...
          <CardContent className="space-y-5 px-6 pb-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-11 border-white/5 bg-white/[0.03] font-mono text-sm font-medium focus:ring-primary/40"
