  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push('/admin/control-panel/cities');
      } else {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <Link href="/admin/control-panel/cities">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">Create a new city/location</p>
              </div>
            </div>
          </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center gap-3 h-full pt-8">
                    ...
                    />
                    <label className="text-sm">Active City</label>
                  </div>
                </div>
