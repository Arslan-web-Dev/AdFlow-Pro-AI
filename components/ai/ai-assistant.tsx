...
import { Bot, Send, X, MessageSquare, Minimize2, User, Sparkles } from 'lucide-react'
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiResponse: Message = {
        ...
        text: "I'm processing your request. As an Enterprise AI, I can help you optimize your ad campaigns or manage your payments. What specifically would you like to know?",
        sender: 'ai',
        timestamp: new Date(),
      }
